          ...
          <div className="left-col">
            ...
            <div className="history-panel">
              <div className="section-tabs">
                ...
                <div className={`stab ${currentSection === 'analytics' ? 'on' : ''}`} onClick={() => handleSectionChange('analytics')}>
                  📊 Analytics
                </div>
                ...
                <div className="analytics-dashboard">
                  ...
                  <div className="analytics-section">
                    <div className="analytics-header">
                      <h3 className="analytics-title">🏆 Best Performing Pairs</h3>
                      <span className="analytics-subtitle">Top 5 by total P&L</span>
                    </div>
                    <div className="pair-performance-list">
                      {[
                        { pair: 'BTC', ico: '₿', bg: 'radial-gradient(circle,#ff9500,#f7931a)', pnl: 8420, trades: 42, winRate: 71 },
                        { pair: 'ETH', ico: 'Ξ', bg: 'radial-gradient(circle,#8ea3f5,#627eea)', pnl: 5240, trades: 38, winRate: 68 },
                        { pair: 'SOL', ico: '◎', bg: 'radial-gradient(circle,#c074fc,#9945ff)', pnl: 3180, trades: 28, winRate: 64 },
                        { pair: 'AVAX', ico: 'A', bg: 'radial-gradient(circle,#ff6060,#e84142)', pnl: 1820, trades: 22, winRate: 59 },
                        { pair: 'LINK', ico: '⬡', bg: 'radial-gradient(circle,#3b82f6,#1d4ed8)', pnl: -420, trades: 18, winRate: 44 },
                      ].map((p, i) => (
                        <div key={i} className="pair-perf-item">
                          <div className="pair-perf-rank">#{i + 1}</div>
                          <div className="pair-perf-coin">
                            <div className="pair-perf-orb" style={{ background: p.bg }}>{p.ico}</div>
                            <div>
                              <div className="pair-perf-name">{p.pair}/USDT</div>
                              <div className="pair-perf-meta">{p.trades} trades · {p.winRate}% win rate</div>
                            </div>
                          </div>
                          <div className="pair-perf-bar-wrap">
                            <div className="pair-perf-bar" style={{ 
                              width: `${Math.abs(p.pnl) / 8420 * 100}%`,
                              background: p.pnl >= 0 ? 'var(--up)' : 'var(--dn)'
                            }}></div>
                          </div>
                          <div className={`pair-perf-pnl ${p.pnl >= 0 ? 'up' : 'dn'}`}>
                  ...
                  <div className="analytics-section">
                    <div className="analytics-header">
                      <h3 className="analytics-title">🔥 Win Streak Tracker</h3>
                      <span className="analytics-subtitle">Current momentum</span>
                    </div>
                    <div className="streak-grid">
                      <div className="streak-card current">
                        <div className="streak-icon">🔥</div>
                        <div className="streak-label">Current Streak</div>
                        <div className="streak-value">7 Wins</div>
                        <div className="streak-sub">Keep it going!</div>
                      </div>
                      <div className="streak-card best">
                        <div className="streak-icon">🏆</div>
                        <div className="streak-label">Longest Streak</div>
                        <div className="streak-value">14 Wins</div>
                        <div className="streak-sub">Feb 2-8, 2026</div>
                      </div>
                      <div className="streak-card worst">
                        <div className="streak-icon">📉</div>
                        <div className="streak-label">Longest Loss Streak</div>
                        <div className="streak-value">5 Losses</div>
                        <div className="streak-sub">Jan 12-14, 2026</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="analytics-section">
                    <div className="analytics-header">
                      <h3 className="analytics-title">⏰ Best Trading Times</h3>
                      <span className="analytics-subtitle">Win rate by hour & day</span>
                    </div>
                      ...
                      <div className="heatmap-grid-wrap">
                        <div className="heatmap-labels-x">
                          {['0', '4', '8', '12', '16', '20'].map(hour => (
                            <div key={hour} className="heatmap-label-x">{hour}h</div>
                          ))}
                        </div>
                              ...
                              {[...Array(24)].map((_, hour) => {
                                ...
                                return (
                                  <div
                                    ...
                                    style={{
                                      background: isProfit 
                                        ? `rgba(34,211,160,${intensity * 0.7})` 
                                        : `rgba(251,113,133,${intensity * 0.7})`,
                                      opacity: intensity < 0.1 ? 0.3 : 1
                                    }}
                                    title={`${['Mon','Tue','Wed','Thu','Fri','Sat','Sun'][day]} ${hour}:00 - ${isProfit ? 'Profitable' : 'Loss'}`}
                                  ></div>
                                );
                              })}
                            </div>
                    ...
                    <div className="heatmap-legend">
                      <span className="heatmap-legend-label">Less profitable</span>
                      <div className="heatmap-legend-gradient"></div>
                      <span className="heatmap-legend-label">More profitable</span>
                    </div>
                  </div>
                  ...
                  <div className="analytics-section">
                    <div className="analytics-header">
                      <h3 className="analytics-title">📊 Risk Metrics</h3>
                      <span className="analytics-subtitle">Portfolio risk analysis</span>
                    </div>
                    <div className="risk-metrics-grid">
                      <div className="risk-metric">
                        <div className="risk-metric-label">Max Drawdown</div>
                        <div className="risk-metric-value" style={{ color: 'var(--dn)' }}>-18.4%</div>
                        <div className="risk-metric-sub">Worst decline from peak</div>
                      </div>
                      <div className="risk-metric">
                        <div className="risk-metric-label">Sharpe Ratio</div>
                        <div className="risk-metric-value" style={{ color: 'var(--teal)' }}>1.84</div>
                        <div className="risk-metric-sub">Risk-adjusted returns</div>
                      </div>
                      <div className="risk-metric">
                        <div className="risk-metric-label">Volatility</div>
                        <div className="risk-metric-value" style={{ color: 'var(--amber)' }}>24.2%</div>
                        <div className="risk-metric-sub">30-day standard deviation</div>
                      </div>
                      <div className="risk-metric">
                        <div className="risk-metric-label">Profit Factor</div>
                        <div className="risk-metric-value" style={{ color: 'var(--up)' }}>2.70</div>
                        <div className="risk-metric-sub">Gross profit / Gross loss</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="analytics-section">
                    <div className="analytics-header">
                      <h3 className="analytics-title">📅 Trading Calendar</h3>
                      <span className="analytics-subtitle">Daily P&L heatmap (last 90 days)</span>
                    </div>
                      ...
                      {[...Array(13)].map((_, week) => (
                        <div key={week} className="calendar-week">
                          {[...Array(7)].map((_, day) => {
                            ...
                            const pnl = hasData ? (Math.random() - 0.4) * 2000 : 0;
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  background: !hasData ? 'rgba(255,255,255,0.03)' :
                                    pnl >= 0 
                                      ? `rgba(34,211,160,${0.2 + intensity * 0.6})` 
                                      : `rgba(251,113,133,${0.2 + intensity * 0.6})`
                                }}
                                title={hasData ? `${pnl >= 0 ? '+' : ''}$${pnl.toFixed(0)}` : 'No trades'}
                              ></div>
                            );
                          })}
                        </div>
                    ...
                    <div className="calendar-legend">
                      <div className="calendar-legend-item">
                        <div className="calendar-legend-box" style={{ background: 'rgba(255,255,255,0.03)' }}></div>
                        <span>No trades</span>
                      </div>
                      <div className="calendar-legend-item">
                        <div className="calendar-legend-box" style={{ background: 'rgba(251,113,133,0.5)' }}></div>
                        <span>Loss</span>
                      </div>
                      <div className="calendar-legend-item">
                        <div className="calendar-legend-box" style={{ background: 'rgba(34,211,160,0.5)' }}></div>
                        <span>Profit</span>
                      </div>
                    </div>
                  </div>
